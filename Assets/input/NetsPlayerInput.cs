...
//     version 1.7.0
//     from Assets/input/NetsPlayerInput.inputactions
//
...
public partial class @NetsPlayerInput: IInputActionCollection2, IDisposable
{
    ...
    private List<IMouseSelectionActions> m_MouseSelectionActionsCallbackInterfaces = new List<IMouseSelectionActions>();
    ...
    public struct MouseSelectionActions
    {
        ...
        public void AddCallbacks(IMouseSelectionActions instance)
        {
            if (instance == null || m_Wrapper.m_MouseSelectionActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_MouseSelectionActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IMouseSelectionActions instance)
        {
            @EdgeSelect.started -= instance.OnEdgeSelect;
            @EdgeSelect.performed -= instance.OnEdgeSelect;
            @EdgeSelect.canceled -= instance.OnEdgeSelect;
        ...
        public void RemoveCallbacks(IMouseSelectionActions instance)
        {
            if (m_Wrapper.m_MouseSelectionActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IMouseSelectionActions instance)
        {
            foreach (var item in m_Wrapper.m_MouseSelectionActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_MouseSelectionActionsCallbackInterfaces.Clear();
